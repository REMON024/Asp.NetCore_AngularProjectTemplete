...
namespace NybSys.API.Controllers
{
    ...
    public class SecurityController : ControllerBase
    {
        ...
        [HttpPost("get-all-controller")]
        public async Task<IActionResult> GetAllController([FromBody] ApiCommonMessage message)
        {
            return await _accessManager.GetAllController(message);
        }

        
        [HttpPost("get-all-action")]
        public async Task<IActionResult> GetAllAction([FromBody] ApiCommonMessage message)
        {
            return await _accessManager.GetAllAction(message);
        }
